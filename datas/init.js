		...
		xhr.onreadystatechange = function() {
			if (xhr.readyState == 4&&xhr.status==200) {
				...
				if(empInfo.code==409){
					...
					if(rates>0){
						//alert("ceshi1")
						if (empInfo.body.urlInfo.urlType){
							...
							//migu_app.ShowMiniEPG("networkout.html?id=100",0);
							//payorder()
							//return
						}
...
function payorder(){
	...
	migu_app.ShowMiniEPG("https://www.miguvideo.com/wap/resource/miguPC_client/payOrder.jsp",callbackUrl,760,390);
}
//体育赛事支付
function paysportsorder(){
	var callbackUrl = "miguplay://html/vodpage.html?playcid="+cids;
	migu_app.ShowMiniEPG("https://www.baidu.com/",callbackUrl,760,390);
}
